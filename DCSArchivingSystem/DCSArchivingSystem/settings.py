...
MEDIA_ROOT = os.path.join(SITE_ROOT, 'testapp/media')
...
SECRET_KEY = ')05dy9rx-d(%*eadi@jvk!d4=&amp;-=+8@zow3yrw7y9*@q$=#=a-'
...
ROOT_URLCONF = 'DCSArchivingSystem.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'DCSArchivingSystem.wsgi.application'

TEMPLATE_DIRS = (
    # Put strings here, like "/home/html/django_templates" or "C:/www/django/templates".
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
	os.path.join(SITE_ROOT, 'testapp/templates'),
)
